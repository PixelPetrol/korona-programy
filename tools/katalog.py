...
META = {
    ...
    ("cyd28", "gry-vol1.bin"): m("K-OS GAME VOL1", "2048, Lunar Lander, Overload, Punch-Through i Payload; 2.8\" NIESPRAWDZONE", "0.5.1", A, "Piotr Korona",
