...
META = {
    ...
    ("cyd28", "gry-vol1.bin"): m("K-OS GAME VOL1", "2048, Lunar Lander, Overload, Punch-Through i Payload; 2.8\" NIESPRAWDZONE", "0.9.0", A, "Piotr Korona",
                          "Ten sam tom gier co na 2.4\", zbudowany dla CYD 2.8\" (2432S028R): dotyk bit-bangiem na wlasnych pinach plytki, podswietlenie GPIO 21. Gry nie maja wlasnej kalibracji - biora ja z K-OS; gdy dla tej plytki nie ma jej na karcie, tom mowi o tym wprost na starcie zamiast uzywac zgadywanych liczb. NIESPRAWDZONE NA SPRZECIE."),
