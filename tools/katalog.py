...
META = {
    ...
    "gry-vol1.bin":     m("K-OS GAME VOL1", "2048, Lunar Lander, Overload i Punch-Through", "0.4.0", A, "Piotr Korona",
    ...
    ("cyd28", "gry-vol1.bin"): m("K-OS GAME VOL1", "2048, Lunar Lander, Overload i Punch-Through; 2.8\" NIESPRAWDZONE", "0.4.0", A, "Piotr Korona",
